        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-green-50 mb-8">
              Schedule a free consultation with our expert team. We'll discuss your vision, assess your space, and provide personalized recommendations.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-green-100">(415) 555-0123</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-green-100">123 Landscape Drive, San Rafael, CA 94901</p>
                </div>
              </div>
            </div>
          </div>
